	...
	public void actionPerformed(ActionEvent event) {
		...
		else if (event.getSource()== this.btnBorrar)
		{
			...
			try {
				...
				if (!borradoExitoso) {
					Utils.mostrarError(this, "No se pudo eliminar la edici�n porque hay un proceso de colocaci�n en curso.");
				}else{
					Utils.mostrarExito(this, "Se elimin� la edici�n exitosamente");
				}
